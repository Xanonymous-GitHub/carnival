...
func (tu *TicketUpdate) SetStatus(ss schema.TicketStatus) *TicketUpdate {
...
func (tu *TicketUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.ApplicationID(); ok {
...
// SetStatus sets the "status" field.
func (tuo *TicketUpdateOne) SetStatus(ss schema.TicketStatus) *TicketUpdateOne {
...
func (tuo *TicketUpdateOne) sqlSave(ctx context.Context) (_node *Ticket, err error) {
	...
	if value, ok := tuo.mutation.ApplicationID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: ticket.FieldApplicationID,
