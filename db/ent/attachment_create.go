...
func (ac *AttachmentCreate) SetType(st schema.AType) *AttachmentCreate {
	ac.mutation.SetType(st)
	return ac
}
...
func (ac *AttachmentCreate) SetTicketsID(id int32) *AttachmentCreate {
