...
func (au *AttachmentUpdate) SetType(st schema.AType) *AttachmentUpdate {
	au.mutation.SetType(st)
	return au
}
...
func (au *AttachmentUpdate) SetTicketsID(id int32) *AttachmentUpdate {
...
// SetType sets the "type" field.
func (auo *AttachmentUpdateOne) SetType(st schema.AType) *AttachmentUpdateOne {
	auo.mutation.SetType(st)
	return auo
}
...
// SetTicketsID sets the "tickets" edge to the Ticket entity by ID.
func (auo *AttachmentUpdateOne) SetTicketsID(id int32) *AttachmentUpdateOne {
