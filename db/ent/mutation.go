...
type ApplicationMutation struct {
	...
	bot_mid                     *string
	bot_active_status           *schema.BotActiveStatus
	applicant_name              *string
	applicant_email             *string
	application_mid             *string
	remark                      *string
	store_type                  *schema.StoreType
	website_url                 *string
	application_status          *schema.ApplicationStatus
...
func (m *ApplicationMutation) SetBotActiveStatus(sas schema.BotActiveStatus) {
	m.bot_active_status = &sas
}

// BotActiveStatus returns the value of the "bot_active_status" field in the mutation.
func (m *ApplicationMutation) BotActiveStatus() (r schema.BotActiveStatus, exists bool) {
...
// If the Application object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApplicationMutation) OldBotActiveStatus(ctx context.Context) (v schema.BotActiveStatus, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApplicationMutation) SetStoreType(st schema.StoreType) {
	m.store_type = &st
}

// StoreType returns the value of the "store_type" field in the mutation.
func (m *ApplicationMutation) StoreType() (r schema.StoreType, exists bool) {
	v := m.store_type
	if v == nil {
		return
	}
...
// If the Application object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApplicationMutation) OldStoreType(ctx context.Context) (v schema.StoreType, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApplicationMutation) SetApplicationStatus(ss schema.ApplicationStatus) {
	m.application_status = &ss
}

// ApplicationStatus returns the value of the "application_status" field in the mutation.
func (m *ApplicationMutation) ApplicationStatus() (r schema.ApplicationStatus, exists bool) {
...
// If the Application object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApplicationMutation) OldApplicationStatus(ctx context.Context) (v schema.ApplicationStatus, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApplicationMutation) SetTicketsID(id int32) {
	m.tickets = &id
}
...
func (m *ApplicationMutation) TicketsID() (id int32, exists bool) {
	if m.tickets != nil {
...
func (m *ApplicationMutation) TicketsIDs() (ids []int32) {
...
func (m *ApplicationMutation) SetField(name string, value ent.Value) error {
	...
	case application.FieldBotMid:
		...
		return nil
	case application.FieldBotActiveStatus:
		v, ok := value.(schema.BotActiveStatus)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
	...
	case application.FieldWebsiteURL:
		...
		return nil
	case application.FieldApplicationStatus:
		v, ok := value.(schema.ApplicationStatus)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
...
func (m *ApplicationStatusHistoryMutation) SetStatus(ss schema.TicketStatus) {
	m.status = &ss
}

// Status returns the value of the "status" field in the mutation.
func (m *ApplicationStatusHistoryMutation) Status() (r schema.TicketStatus, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// If the ApplicationStatusHistory object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApplicationStatusHistoryMutation) OldStatus(ctx context.Context) (v schema.TicketStatus, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApplicationStatusHistoryMutation) SetField(name string, value ent.Value) error {
	...
	case applicationstatushistory.FieldApplicationID:
		...
		return nil
	case applicationstatushistory.FieldStatus:
		v, ok := value.(schema.TicketStatus)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetStatus(v)
...
func (m *AttachmentMutation) SetType(st schema.AType) {
	m._type = &st
}

// GetType returns the value of the "type" field in the mutation.
func (m *AttachmentMutation) GetType() (r schema.AType, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// If the Attachment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AttachmentMutation) OldType(ctx context.Context) (v schema.AType, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// SetTicketsID sets the "tickets" edge to the Ticket entity by id.
func (m *AttachmentMutation) SetTicketsID(id int32) {
	m.tickets = &id
}
...
// TicketsID returns the "tickets" edge ID in the mutation.
func (m *AttachmentMutation) TicketsID() (id int32, exists bool) {
	if m.tickets != nil {
		return *m.tickets, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// TicketsID instead. It exists only for internal usage by the builders.
func (m *AttachmentMutation) TicketsIDs() (ids []int32) {
	if id := m.tickets; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *ReviewerMutation) SetIimsRole(sr schema.IIMSRole) {
	m.iims_role = &sr
}

// IimsRole returns the value of the "iims_role" field in the mutation.
func (m *ReviewerMutation) IimsRole() (r schema.IIMSRole, exists bool) {
	v := m.iims_role
	if v == nil {
		return
	}
...
// If the Reviewer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ReviewerMutation) OldIimsRole(ctx context.Context) (v schema.IIMSRole, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func withTicketID(id int32) ticketOption {
...
func (m *TicketMutation) SetID(id int32) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *TicketMutation) ID() (id int32, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *TicketMutation) IDs(ctx context.Context) ([]int32, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
// SetStatus sets the "status" field.
func (m *TicketMutation) SetStatus(ss schema.TicketStatus) {
	m.status = &ss
}

// Status returns the value of the "status" field in the mutation.
func (m *TicketMutation) Status() (r schema.TicketStatus, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// If the Ticket object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TicketMutation) OldStatus(ctx context.Context) (v schema.TicketStatus, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
