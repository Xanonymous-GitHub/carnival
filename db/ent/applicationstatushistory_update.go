...
func (ashu *ApplicationStatusHistoryUpdate) SetStatus(ss schema.TicketStatus) *ApplicationStatusHistoryUpdate {
	ashu.mutation.SetStatus(ss)
	return ashu
}
...
// SetStatus sets the "status" field.
func (ashuo *ApplicationStatusHistoryUpdateOne) SetStatus(ss schema.TicketStatus) *ApplicationStatusHistoryUpdateOne {
	ashuo.mutation.SetStatus(ss)
	return ashuo
}
