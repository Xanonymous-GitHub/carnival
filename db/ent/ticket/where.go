...
func ID(id int32) predicate.Ticket {
...
func IDEQ(id int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
...
func IDIn(ids ...int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
...
func IDNotIn(ids ...int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
...
func IDGTE(id int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
...
func IDLT(id int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
...
func IDLTE(id int32) predicate.Ticket {
	return predicate.Ticket(func(s *sql.Selector) {
...
func StatusEQ(v schema.TicketStatus) predicate.Ticket {
	vc := v
	return predicate.Ticket(func(s *sql.Selector) {
...
func StatusNEQ(v schema.TicketStatus) predicate.Ticket {
	vc := v
	return predicate.Ticket(func(s *sql.Selector) {
...
func StatusIn(vs ...schema.TicketStatus) predicate.Ticket {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNotIn(vs ...schema.TicketStatus) predicate.Ticket {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
