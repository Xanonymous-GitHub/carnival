...
type Attachment struct {
	...
	Type schema.AType `json:"type,omitempty"`
...
func (*Attachment) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case attachment.FieldType, attachment.FieldObsOid, attachment.FieldObsHash:
	...
	for i := range columns {
		...
		case attachment.FieldType:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				a.Type = schema.AType(value.String)
			}
		...
		case attachment.ForeignKeys[1]:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				a.ticket_attachments = new(int32)
				*a.ticket_attachments = int32(value.Int64)
			}
		}
	}
	return nil
