...
var (
	...
	AttachmentsColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeEnum, Enums: []string{"biz_cert", "store_appearance", "id_document", "other", "supplement", "reference"}},
		...
		{Name: "ticket_attachments", Type: field.TypeInt32, Nullable: true},
	}
	...
	TicketsColumns = []*schema.Column{
		{Name: "ticket_id", Type: field.TypeInt32, Increment: true},
		{Name: "application_id", Type: field.TypeUUID},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"created", "replied", "completed"}},
