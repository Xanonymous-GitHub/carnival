...
type Application struct {
	...
	BotActiveStatus schema.BotActiveStatus `json:"bot_active_status,omitempty"`
	...
	StoreType schema.StoreType `json:"store_type,omitempty"`
	...
	ApplicationStatus schema.ApplicationStatus `json:"application_status,omitempty"`
	...
	for i := range columns {
		...
		case application.FieldBotActiveStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				a.BotActiveStatus = schema.BotActiveStatus(value.String)
			}
		...
		case application.FieldStoreType:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				a.StoreType = schema.StoreType(value.String)
			}
		...
		case application.FieldApplicationStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				a.ApplicationStatus = schema.ApplicationStatus(value.String)
			}
