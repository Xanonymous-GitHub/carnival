...
func (au *ApplicationUpdate) SetBotActiveStatus(sas schema.BotActiveStatus) *ApplicationUpdate {
	au.mutation.SetBotActiveStatus(sas)
	return au
}
...
func (au *ApplicationUpdate) SetStoreType(st schema.StoreType) *ApplicationUpdate {
	au.mutation.SetStoreType(st)
	return au
}
...
func (au *ApplicationUpdate) SetApplicationStatus(ss schema.ApplicationStatus) *ApplicationUpdate {
	au.mutation.SetApplicationStatus(ss)
	return au
}
...
func (au *ApplicationUpdate) SetTicketsID(id int32) *ApplicationUpdate {
...
func (au *ApplicationUpdate) SetNillableTicketsID(id *int32) *ApplicationUpdate {
	if id != nil {
...
// SetBotActiveStatus sets the "bot_active_status" field.
func (auo *ApplicationUpdateOne) SetBotActiveStatus(sas schema.BotActiveStatus) *ApplicationUpdateOne {
	auo.mutation.SetBotActiveStatus(sas)
	return auo
}
...
// SetStoreType sets the "store_type" field.
func (auo *ApplicationUpdateOne) SetStoreType(st schema.StoreType) *ApplicationUpdateOne {
	auo.mutation.SetStoreType(st)
	return auo
}
...
// SetApplicationStatus sets the "application_status" field.
func (auo *ApplicationUpdateOne) SetApplicationStatus(ss schema.ApplicationStatus) *ApplicationUpdateOne {
	auo.mutation.SetApplicationStatus(ss)
	return auo
}
...
// SetTicketsID sets the "tickets" edge to the Ticket entity by ID.
func (auo *ApplicationUpdateOne) SetTicketsID(id int32) *ApplicationUpdateOne {
	auo.mutation.SetTicketsID(id)
	return auo
}

// SetNillableTicketsID sets the "tickets" edge to the Ticket entity by ID if the given value is not nil.
func (auo *ApplicationUpdateOne) SetNillableTicketsID(id *int32) *ApplicationUpdateOne {
	if id != nil {
