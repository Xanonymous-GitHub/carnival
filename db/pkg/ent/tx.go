...
func (tx *Tx) init() {
	...
	tx.ApplicationAssignmentHistory = NewApplicationAssignmentHistoryClient(tx.config)
	tx.ApplicationStatusHistory = NewApplicationStatusHistoryClient(tx.config)
	tx.Attachment = NewAttachmentClient(tx.config)
	tx.Reviewer = NewReviewerClient(tx.config)
